...
fun SignUpScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = "Start tracking your digital habits",
                color = OnDarkMuted,
                fontSize = 14.sp
            )
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = { Text("Full Name", color = OnDarkMuted, fontSize = 13.sp) },
                    singleLine = true,
                ...
                OutlinedTextField(
                    ...
                    label = { Text("Confirm Password", color = OnDarkMuted, fontSize = 13.sp) },
                    singleLine = true,
                    modifier = Modifier.fillMaxWidth(),
                    shape = RoundedCornerShape(10.dp),
                    colors = signupFieldColors(),
                    ...
                    trailingIcon = {
                        IconButton(onClick = { confirmPasswordVisible = !confirmPasswordVisible }) {
                            Text(if (confirmPasswordVisible) "🙈" else "👁", fontSize = 16.sp)
                        }
                    }
                )
                    ...
                    onClick = {
                        ...
                        scope.launch {
                            ...
                            when {
                                ...
                                else -> errorMessage = "Sign up failed. Please try again."
                            }
                        }
                    },
                    modifier = Modifier
            ...
            Row(
                ...
                Text("Already have an account?", color = OnDarkMuted, fontSize = 14.sp)
                TextButton(onClick = onNavigateToLogin) {
                    Text("Log In", color = CyanBlue, fontWeight = FontWeight.SemiBold, fontSize = 14.sp)
                }
            }
        }
    }
